...
local function sync_bootstrap_to_theme_host()
	local ok, err = pcall(function()
		...
		utils.write_file(fs.join(destDir, "bootstrap-20260922-empty-library.js"), content)
...
local function register_injections(caller)
	local bootstrapId = millennium.add_browser_js(INJECT_SUBDIR .. "/bootstrap-20260922-empty-library.js", ".*")
